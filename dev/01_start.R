...
usethis::use_mit_license( name = "Chintan Pathak, Don MacKenzie" )  # You can set another license here
...
golem::use_favicon("C:/Users/chintan/Downloads/favicon_io(1)/favicon.ico") # path = "path/to/ico". Can be an online file. 
